...
public class ParallelController {
    ...
    public String index(Model model,Authentication auth) {
        ...
        model.addAttribute("parallels",parallelService.getAllSingle());
        return "parallels/index";
    }
    
    @PostMapping("/paralelos/store")
